<div class="row">
	<div class="col-md-12">
	<a href="index.php?view=est_gra&id=<?php echo $_GET["id_grado"]; ?>" class="btn pull-right btn-sm btn-info"><i class='fa fa-arrow-left'></i> Regresar</a>
...
<script>
	$("#loadlist").submit(function(e){
		...
		$.get("./?action=cargarconducta",d,function(data){
			console.log(data);
			$("#data").html(data);
