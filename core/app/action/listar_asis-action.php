...
<a href="./report/asistencia-word.php?id_grado=<?php echo $_GET["id_grado"]; ?>&start_at=<?php echo $_GET["start_at"]; ?>&finish_at=<?php echo $_GET["finish_at"]; ?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-download"></i> Descargar</a>
			Lista
			</div>
